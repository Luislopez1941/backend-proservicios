...
CREATE TABLE "public"."localities" (
    ...
    "id_state" INTEGER NOT NULL,
    "id_municipality" INTEGER NOT NULL,
    "type" VARCHAR(255) NOT NULL DEFAULT 'locality',
...
-- CreateIndex
CREATE UNIQUE INDEX "municipalities_name_id_state_key" ON "public"."municipalities"("name", "id_state");
...
-- AddForeignKey
ALTER TABLE "public"."users" ADD CONSTRAINT "users_id_state_fkey" FOREIGN KEY ("id_state") REFERENCES "public"."states"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."users" ADD CONSTRAINT "users_id_municipality_fkey" FOREIGN KEY ("id_municipality") REFERENCES "public"."municipalities"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "public"."jobs" ADD CONSTRAINT "jobs_id_municipality_fkey" FOREIGN KEY ("id_municipality") REFERENCES "public"."municipalities"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."jobs" ADD CONSTRAINT "jobs_id_locality_fkey" FOREIGN KEY ("id_locality") REFERENCES "public"."localities"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."municipalities" ADD CONSTRAINT "municipalities_id_state_fkey" FOREIGN KEY ("id_state") REFERENCES "public"."states"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."localities" ADD CONSTRAINT "localities_id_state_fkey" FOREIGN KEY ("id_state") REFERENCES "public"."states"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."localities" ADD CONSTRAINT "localities_id_municipality_fkey" FOREIGN KEY ("id_municipality") REFERENCES "public"."municipalities"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
